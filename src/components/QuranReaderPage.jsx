...
import { computeMastery, masteryColor, normalizeAr, arabicRoot } from "../utils/arabicUtils";
            ...
            >
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4, alignItems: "flex-end", flexShrink: 0 }}>
                  ...
                  {timestampsMap[tskey(selectedSurah.number, a.numberInSurah)] && <div className="ts-status loaded">⚡ TS</div>}
                </div>
              </div>
